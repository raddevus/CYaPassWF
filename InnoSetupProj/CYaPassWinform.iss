...
LicenseFile=C:\dev\WinForms\CYaPass\cyapassLicense.txt
OutputDir=C:\dev\WinForms\CYaPass\InnoSetupProj
OutputBaseFilename=CYaPassInstall
SetupIconFile=C:\dev\WinForms\CYaPass\CYaPass\CYaPass.ico
Compression=lzma
...
[Files]
Source: "C:\dev\WinForms\CYaPass\CYaPass\bin\Release\CYaPass.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\dev\WinForms\CYaPass\CYaPass\bin\Release\Newtonsoft.Json.dll"; DestDir: "{app}"; Flags: ignoreversion
